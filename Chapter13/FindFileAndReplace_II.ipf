...
item: Rename File/Directory
  Old Pathname=%FOUNDFILE%\%FINDFILE%.Bak
  New Filename=%FINDFILE%.Bak.Old
end
item: Install File
  Source=C:\scripts\sms\swdist\Foo2.doc
  Destination=%FOUNDFILE%\Foo.doc
