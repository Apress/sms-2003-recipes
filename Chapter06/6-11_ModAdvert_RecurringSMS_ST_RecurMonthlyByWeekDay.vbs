...
'"Occurs the second Monday of every 4 months starting now()"
...
Set advNewRecurToken = objSMS.Get("SMS_ST_RecurMonthlyByWeekday"). _
    SpawnInstance_()
advNewRecurToken.ForNumberOfMonths = 4
advNewRecurToken.Day = 2 '2=Monday 
advNewRecurToken.WeekOrder = 2 '2=Second week of month
...
'1=sunday, 2=monday, ...7 =sat
''0=last week of month

' Remarks
' Network Discovery is the only SMS component that uses the duration properties.
