...
wscript.echo "All Programs with 'Suppress Program " & _
    "Notifications' configured."
for each objProgram in colPrograms
    if (objProgram.ProgramFlags and SUPPRESS_NOTIFICATIONS) then
        wscript.echo objProgram.ProgramName & vbTAB & _
